                        ...
                        <form class="form-horizontal" method="POST" action="${pageContext.request.contextPath}/registrasi/create" >  
                            <fieldset>
                                <div ng-app="">
                                    ...
                                    <!-- Form Name -->
                                    <legend>Identitas Mahasiswa {{ typing }} </legend> 
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input id="nama" name="nama" placeholder="masukkan nama lengkap" class="form-control" required="" type="text" ng-model="typing">
                                        </div>
                                    </div>
